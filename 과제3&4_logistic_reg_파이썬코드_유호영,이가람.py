'''
# 과제 3&4 Logistic Regression, 18011152 유호영 / 21011215 이가람

"Generating Datasets using Scikit-learn"

Assignment 3&4 - Logistic Regression
...
for n_samples in cluster_num_list:
    ...
    grid = GridSearchCV(LogisticRegression(random_state=100), param_grid, cv=kfold, scoring='accuracy')
